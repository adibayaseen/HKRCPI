...
* (g) Target Compound Screening (TCS) for Drugreprurposing scores for all pairs of proteins in the test set for one fold can be downloaded from this link [https://docs.google.com/spreadsheets/d/1480q6VmhbPlBet1JrMydTb5p_Mp_zYJm/edit?usp=sharing&ouid=108408133666428329638&rtpof=true&sd=true]<br/>
